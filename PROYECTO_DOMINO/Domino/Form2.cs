...
namespace Domino
{
    public partial class Form2 : Form
    {
        ...
        public void SetVisible(bool v) // num_jug/jug1-jug2
        {
            this.visible = v;
        }
        ...
        private void PonMensajeServidor(string mensaje)
        {
            ...
            this.listBox2.Items.Add(Timeonly + ": " + mensaje);
        }
        ...
        private void Notificar_Numero_Nuevo(Coordenada posicion, int numero)
        {
            ...
            string peticion = "1/" + Convert.ToString(posicion.X) + " " + Convert.ToString(posicion.Y) + " " + Convert.ToString(numero);
        ...
        private void Comprobar_Afinidad_Ficha(Ficha ficha_jugada, Coordenada punto_insercion)
        {
            ...
            if (encontrado)
            {
                ...
                if (ficha_jugada.NUM_1 == Convert.ToInt32(dataGridView1.Rows[punto_insercion.Y].Cells[punto_insercion.X].Value))
                {
                    ...
                    peticion = "2/- " + Convert.ToString(posicion_seleccionada.X) + " " + Convert.ToString(posicion_seleccionada.Y);
                    byte[] msg = System.Text.Encoding.ASCII.GetBytes(peticion);
                    server.Send(msg);
                    ...
                    listBox1.Items.RemoveAt(actual_index);
                }
        ...
        {
            idLbl.Text = "ID: " + Convert.ToString(id_partida) + "N. Formulario del jugador: " + Convert.ToString(nForm);
        ...
        {
            actual_index = listBox1.SelectedIndex;
            string ficha_string = Convert.ToString(listBox1.Items[listBox1.SelectedIndex]);

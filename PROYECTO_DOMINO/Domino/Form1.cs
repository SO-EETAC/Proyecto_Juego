...
namespace Domino
{
    public partial class Form1 : Form
    {
            ...
            while(true)
            {
                ...
                switch (codigo)
                {
                    ...
                    case 5:
                        ...
                        formularios[nform].TomaRespuestas5(mensaje);
                        ...
                        **********************************************************************************/
                        //nform = Convert.ToInt32(trozos[1]);
                        mensaje = trozos[2].Split('\0')[0];
                        seg = mensaje.Split(new char[] { '_' }, 2);
                    ...
                    case 6:
                        ...
                        //RESPUESTAS INVITACIONES: 6/0 (empezar partida) ó 6/-1(no se puede jugar)
                    ...
                    case 7:  // Tenemos un nuevo movimiento
                        mensaje = trozos[2].Split('\0')[0];
                        F2.TomaRespuesta7(mensaje);

                        break;

                    case 8:  // Actualizamos la lista de posiciones jugables
                        mensaje = trozos[2].Split('\0')[0];
                    ...
                    case 9: // Recibimos las fichas
                        mensaje = trozos[2].Split('\0')[0];
                        F2.TomaRespuesta9(mensaje);

                        break;

                    case 10: // Nos dicen que es nuestro turno
                        mensaje = trozos[2].Split('\0')[0];
        ...
        private void InvitarBtn_Click(object sender, EventArgs e)
        {
            ...
            /**********************************************************************************
            //Ponemos en marcha un thread para cada partida que abramos
            ThreadStart ts = delegate { PonerEnMarchaFormulario2(1, usuario, listado_jugadores); };
            Thread T = new Thread(ts);
            T.Start();
            *********************************************************************************/
